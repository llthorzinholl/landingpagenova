      ...
      <div className="container mx-auto px-4">
        ...
        >
          <div className="max-w-2xl">
            <h2 id="services-heading" className="text-aes-cyan font-bold tracking-[0.2em] uppercase text-[10px] md:text-xs mb-3 md:mb-4">
              Our Expertise
            </h2>
          ...
          {SERVICES.map((service) => (
            ...
            >
              <div className="relative h-48 md:h-56 lg:h-60 overflow-hidden rounded-t-lg">
                <img
                  src={service.image}
                  alt={`AES ${service.title} - ${service.description}`}
              ...
              <div className="p-6 md:p-8 flex-grow">
                <div className="flex items-center gap-3 mb-4">
                  <span className="text-2xl md:text-3xl" aria-hidden="true">{service.icon}</span>
